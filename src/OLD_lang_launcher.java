...
public class OLD_lang_launcher {
	...
	{
		s = store;
		s.debug.message("lang_launcher:start");
	...
	public void set_language(String language_name)
	{
		...
		s.debug.message("lang_launcher:set_language:" + language_name);
	...
	{
		s.debug.message("lang_launcher:get_label:index:" + index);
		String temp = "";
	...
	{
		s.debug.message("lang_launcher:get_caption:index:" + index);
		String temp = "";
	...
	{
		s.debug.message("lang_launcher:get_text:index:" + index);
		String temp = "";
		if(index < texts.size()) {
	...
	{
		s.debug.message("lang_launcher:get_subtitle:index:" + index);
		String temp = "";
